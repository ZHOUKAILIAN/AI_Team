# AI_Team Single-Session Workflow Design
...
The `ai-company-workflow` skill becomes the real workflow executor inside the active Codex session.
...
- update installed `codex-skill/ai-company-workflow/SKILL.md`
...
- update `ai_company` review output to reflect real stage statuses
